...
def calculate_anchors(dataset_anno_path=r'VOCdevkit/VOC2007/Annotations', anchorsPath='yolo_anchors.txt',
                      anchors_num=9, SIZE=416):
...
if __name__ == "__main__":
    # 数据集xml注释路径
    dataset_anno_path = 'VOCdevkit/VOC2007/Annotations'
